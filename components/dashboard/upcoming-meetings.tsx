  ...
  return (
    <Card className="lg:col-span-2">
      ...
      <CardContent className="space-y-2">
        {events.length === 0 && (
          <div className="text-xs text-ink-300/50 text-center py-8">Nothing scheduled.</div>
        )}
        {events.map((m, i) => {
          ...
          return (
            <motion.div
              ...
              className="flex items-center gap-4 p-3 -mx-3 rounded-xl hover:bg-bone-50/60 transition-colors cursor-pointer group"
            >
